...
Алгебраическое доказательство тех же утверждений (тождество
(u·L)² = LᵀuuᵀL ⇒ E_L = √(Lᵀ·M·L), где M — тензор Ди Дзензо;
угловое усреднение ⇒ монотонная функция от √λ_max): см. docs/equivalence.md.
